...
const SettingsModal: React.FC<Props> = ({ isOpen, onClose, user, settings, onUpdateSettings }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/60 dark:bg-black/80 backdrop-blur-sm p-4 md:p-8 animate-fade-in">
      <div className="w-full max-w-5xl h-[85vh] bg-white dark:bg-[#09090b] border border-zinc-200 dark:border-zinc-800 rounded-3xl overflow-hidden shadow-2xl flex flex-col md:flex-row animate-slide-up">
        
        {/* Sidebar */}
        <aside className="w-full md:w-64 bg-zinc-50 dark:bg-zinc-950/50 border-r border-zinc-200 dark:border-zinc-800 p-6 flex flex-col">
        ...
        {/* Content Area */}
        <main className="flex-1 overflow-y-auto custom-scrollbar bg-white dark:bg-[#09090b]">
           {/* Header */}
           <div className="sticky top-0 z-10 bg-white/90 dark:bg-[#09090b]/90 backdrop-blur-md border-b border-zinc-200 dark:border-zinc-800 px-8 py-6 flex justify-between items-center">
               <div>
                      ...
                      <section>
                          ...
                          <div className="grid grid-cols-3 gap-4">
                              <button 
                                ...
                                className={`group relative p-4 rounded-xl border flex flex-col items-center gap-3 transition-all ${
